...
export class List {
    ...
    columns = [
        ...
        { field: "IsApprovedGeneralManagerLabel", title: "Approval GM" },
        { field: "IsApprovedDirecturLabel", title: "Approval Direktur" },
        { field: "CreatedBy", title: "Dibuat Oleh" }
    ];

    rowFormatter(data, index) {
        if (data.IsApprovedManager && data.IsApprovedGeneralManager && data.IsApprovedDirectur)
        ...
        return this.service.search(arg)
            .then(result => {
                result.data.map(data => {
                    ...
                    data.IsApprovedDirecturLabel = data.IsApprovedDirectur ? "SUDAH" : "BELUM";
                    return data;
                });
                return {
