...
export class PurchaseOrderItem {
  ...
  activate(context) {
    ...
    this.useVat = (this.context.context && this.context.context.options && this.context.context.options.useVat) || false;
    ...
    const unitCode = (this.context.context && this.context.context.options && this.context.context.options.unitCode) || null;
    this.filter={
      "UnitName": unitCode,
      "IsPosted":false
    };
