...
export class DataForm {
  ...
  get filterCopyROData() {
    //return { "RO_GarmentId": null, "SCGarmentId":null }
    //return { "RO_GarmentId== null && SCGarmentId > 0": true };
    return { [`IsPosted== true && RO_Number != "${this.costCalculationGarment ? this.costCalculationGarment.RO_Number : null}" && IsApprovedIE== true`]:true};
  }
  ...
  download() {
    var endpoint = 'ro-garments/download-template/new';
    var request = {
        method: 'GET'
    };
