...
export class Edit {
    ...
    async activate(params) {
        ...
        if (this.data) {
            ...
            console.log("prMasterIds", prMasterIds);
            ...
            console.log("prMasterItemIds", prMasterItemIds);
            if (prMasterIds.length > 0) {
                ...
                console.log("prMasterResult", prMasterResult);
                let prMasters = [];
                ...
                console.log("prMasters", prMasters);
                let materialsFilter = {};
                ...
                console.log("ccMaterials", ccMaterials);
                this.data.CostCalculationGarment_Materials.forEach(material => {
                    ...
                    if (material.PRMasterItemId > 0) {
                        ...
                        console.log("budgetQuantities", budgetQuantities);
                        console.log("availableQuantity", material.AvailableQuantity);
                    }
                });
                console.log("data", this.data.CostCalculationGarment_Materials);
            }
        }
    }
