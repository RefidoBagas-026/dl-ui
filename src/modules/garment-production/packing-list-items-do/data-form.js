...
export class DataForm {
    ...
    get filterDO() {
        let filter = {
            Status: 0, // 0: Outstanding,1:Amendment,2: Created Packing List
            buyerAgentId: this.data.buyerAgent ? this.data.buyerAgent.Id || this.data.buyerAgent.id : 0
        };
        return filter;
    }
    ...
    ExportSalesDOView = (item) => {
        return item && (item.exportSalesDONo || item.ExportSalesDONo) ? (item.exportSalesDONo || item.ExportSalesDONo) : '';
    }
