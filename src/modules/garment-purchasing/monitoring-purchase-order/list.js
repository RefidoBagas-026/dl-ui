...
export class List {
    ...
    exportToXls() {
        ...
        if (this.Type === "Report") {
            ...
            if (this.err == false) {
                this.error = {}
                this.purchasingService.generateExcel(args.epono, args.unit, args.roNo, args.article, args.poSerialNumber, args.doNo, args.ipoStatus, args.supplier, args.status, args.dateFrom, args.dateTo, args.dateFromEx, args.dateToEx);
            }
        }
