...
export class Service extends RestService {
    ...
    createTypeProses(data) {
        var endpoint = `${serviceUri}/${typeproses}`;
        return super.post(endpoint, data);
    }

    updateTypeProses(data) {
        var endpoint = `${serviceUri}/${typeproses}/${data._id}`;
        return super.put(endpoint, data);
    }

    deleteTypeProses(data) {
        var endpoint = `${serviceUri}/${typeproses}/${data._id}`;
        return super.delete(endpoint, data);
    }
}
...
export class SalesService extends RestService {
    ...
    GetCC(info) {
        var endpoint = `${serviceUriCC}/dynamic`;
        return super.list(endpoint, info);
    }

    GetCCMaterial(info){
        var endpoint = `${serviceUriCC}/materials/dynamic`;
        return super.list(endpoint, info);
    }
