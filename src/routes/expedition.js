module.exports = [
  ...
  {
    route: "realization-payment-without-vb",
    name: "realization-payment-without-vb",
    moduleId: "./modules/purchasing/reports/realization-payment-without-vb/index",
    nav: true,
    title: "Laporan Realisasi Pembayaran Tanpa VB",
    auth: true,
    settings: {
      group: "finance",
      subGroup: "vb",
