...
export async function configure(aurelia) {
    aurelia.use
        ...
        .plugin("aurelia-api", config => {
            ...
            var core = "https://com-danliris-service-core-v8.azurewebsites.net/v1/";
            ...
            var inventoryAzure = "https://com-danliris-service-inventory-prd-v8.azurewebsites.net/v1/";
            ...
            var garmentProduction = "https://com-danliris-service-garment-v8.azurewebsites.net/";
            //var packingInventory = "https://com-danliris-service-packing-inventory.azurewebsites.net/v1/";
            var packingInventory = "https://com-danliris-service-packing-inventory-v8.azurewebsites.net/v1/";
